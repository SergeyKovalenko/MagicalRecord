...
const struct MappedEntityAttributes MappedEntityAttributes = {.mappedEntityID = @"mappedEntityID", .nestedAttribute = @"nestedAttribute", .sampleAttribute = @"sampleAttribute", .testMappedEntityID = @"testMappedEntityID",};

const struct MappedEntityUserInfo MappedEntityUserInfo = {.relatedByAttribute = @"mapped",};
